...
export default function StandingTable() {
    ...
    return (
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg m-2 py-2 bg-projectGrays-300">
            ...
            <table className='w-full text-sm text-left text-white'>
                <thead>
                    <tr>
                        ...
                        <th scope='col' className='px-4 py-3 max-w-[50px]'>Equipo</th>
                    ...
                    {sortedTeams.map((team: Positions) => {
                        ...
                        return (
                            <tr key={team.team_id} className='odd:bg-[#2C2C2C] p-2 rounded-lg'>
                                ...
                                <td className='m-1 ml-0 px-4 '>{team.overall_league_PTS}</td>
                                <td className='m-1 ml-0 px-4 '>{team.overall_league_payed}</td>
                            </tr>
                        )
                    })}
                </tbody>
